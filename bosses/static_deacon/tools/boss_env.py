"""Import first in every Static Deacon tool script: wires in the shared pipeline (tools/blockbench), points it at this
boss (sound namespace + model output folder bosses/static_deacon/models) and selects the liturgical material palette,
...
lib.BOSS_ID = BOSS
lib.OUT = MODELS
texture.use("liturgical", TEXTURE_SRC)
